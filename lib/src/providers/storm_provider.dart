...
final stormProvider = AsyncNotifierProvider<StormNotifier, EntropyStorm?>(
  StormNotifier.new,
);
...
class StormNotifier extends AsyncNotifier<EntropyStorm?> {
  ...
  Future<void> scheduleStorm(DateTime startTime) async {
    ...
    final storm = EntropyStorm(
      id: 'storm_${_uuid.v4()}',
      scheduledStart: startTime.toUtc(),
  ...
  void _resolveStorm(EntropyStorm storm) {
    ...
    final finalStatus = survived ? StormStatus.survived : StormStatus.failed;
